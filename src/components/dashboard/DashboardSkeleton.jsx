...
const DashboardSkeleton = () => {
  return (
    <div className="space-y-8 animate-pulse">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-indigo-950 rounded-[2rem] p-8 text-white relative overflow-hidden shadow-sm dark:shadow-none">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white dark:bg-slate-900/10 rounded-xl" />
            <div className="w-32 h-9 bg-white dark:bg-slate-900/10 rounded-xl" />
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          { icon: Home, border: "border-l-4 border-slate-300 dark:border-slate-600" },
          { icon: Users, border: "border-l-4 border-slate-300 dark:border-slate-600" },
          { icon: AlertTriangle, border: "border-l-4 border-slate-300 dark:border-slate-600" },
          { icon: Package, border: "border-l-4 border-slate-300 dark:border-slate-600" }
        ].map((item, i) => (
          <div key={i} className={`bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 ${item.border} shadow-sm dark:shadow-none flex flex-col justify-between h-32`}>
            ...
            <div>
              ...
              <div className="w-32 h-3 bg-slate-100 dark:bg-slate-800 rounded-sm mt-2" />
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white dark:bg-slate-900 p-6 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm dark:shadow-none">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-slate-100 dark:bg-slate-800 rounded-lg text-slate-300">
                  <TrendingUp size={18} />
                </div>
                <div className="space-y-1.5">
                  <div className="w-36 h-4 bg-slate-200 rounded-md" />
                  <div className="w-48 h-2.5 bg-slate-100 dark:bg-slate-800 rounded-sm" />
                </div>
              </div>
              <div className="flex gap-4">
                <div className="w-20 h-3.5 bg-slate-100 dark:bg-slate-800 rounded-sm" />
                <div className="w-20 h-3.5 bg-slate-100 dark:bg-slate-800 rounded-sm" />
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[2rem] shadow-sm dark:shadow-none overflow-hidden">
            <div className="px-6 py-5 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-slate-100 dark:bg-slate-800 text-slate-300 rounded-lg">
                  <MapPin size={18} />
                </div>
                <div className="space-y-1.5">
                  <div className="w-36 h-4 bg-slate-200 rounded-md" />
              ...
              {[1, 2, 3].map((row) => (
                <div key={row} className="px-6 py-5 flex items-center justify-between">
                  <div className="space-y-2">
                    ...
                    <div className="w-24 h-2.5 bg-slate-100 dark:bg-slate-800 rounded-sm" />
                  </div>
                  <div className="w-32 h-4 bg-slate-100 dark:bg-slate-800 rounded-md" />
                  <div className="w-16 h-4 bg-slate-100 dark:bg-slate-800 rounded-md" />
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white dark:bg-slate-900 p-5 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm dark:shadow-none">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[1, 2, 3, 4].map((s) => (
                <div key={s} className="flex flex-col items-center justify-center p-4 bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800/50 rounded-2xl h-24">
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[2rem] p-5 shadow-sm dark:shadow-none space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Bell size={14} className="text-slate-300" />
                <div className="w-28 h-3.5 bg-slate-200 rounded-sm" />
              </div>
              <div className="w-16 h-4 bg-slate-100 dark:bg-slate-800 rounded-sm" />
            </div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[2rem] p-5 shadow-sm dark:shadow-none space-y-5">
            <div className="flex items-center gap-2">
